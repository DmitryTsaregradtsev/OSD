						...
						'<a id="a" href="#">',
						  	'<div class="fkeeper">',
								...
								'<div id="fdescription">',
									'<div id="container">',
									'<h3>{name} {surname}</h3>',
									'<p style="border-bottom:1px solid #ccc; margin-bottom:5px;">{sallary}$/hr, location: {location}</p>',
									'<p>{aboutme}</p>',
								...
								'</div>',
								'<div id="buttons_wrap">',
									'<div id="profile" class="buttons">Profile</div>',
									'<div id="contact" class="buttons">Contact</div>',
								'</div>',
